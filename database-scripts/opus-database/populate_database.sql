...
INSERT INTO STUDENT (user_id, student_id) VALUES (3, '14 000 001');
INSERT INTO STUDENT (user_id, student_id) VALUES (4, '14 000 002');
INSERT INTO STUDENT (user_id, student_id) VALUES (5, '14 000 003');
INSERT INTO STUDENT (user_id, student_id) VALUES (6, '14 000 004');
INSERT INTO STUDENT (user_id, student_id) VALUES (7, '14 000 005');
INSERT INTO STUDENT (user_id, student_id) VALUES (8, '14 000 006');
INSERT INTO STUDENT (user_id, student_id) VALUES (9, '14 000 007');
INSERT INTO STUDENT (user_id, student_id) VALUES (10, '14 000 008');
INSERT INTO STUDENT (user_id, student_id) VALUES (11, '14 000 009');
INSERT INTO STUDENT (user_id, student_id) VALUES (12, '14 000 010');
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1sn', 'session 1', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1te', 'session 1', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1ti', 'session 1', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1to', 'session 1', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
