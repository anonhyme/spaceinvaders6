...
/* Created on:     2015-05-11 14:07:37                          */
/*==============================================================*/

CREATE SCHEMA note;

/*
drop index ADMINISTRATIVE_ELEMENT_PK;

drop table note.ADMINISTRATIVE_ELEMENT;

drop index ADMINISTRATIVE_GROUP_FK2;

drop index ADMINISTRATIVE_GROUP_FK;

drop index ADMINISTRATIVE_GROUP_PK;

drop table note.ADMINISTRATIVE_GROUP;

drop index ADMINISTRATIVE_HIERARCHY2_FK;

drop index ADMINISTRATIVE_HIERARCHY_FK;

drop index ADMINISTRATIVE_HIERARCHY_PK;

drop table note.ADMINISTRATIVE_HIERARCHY;

drop index ASSIGNED_GROUP_FK3;

drop index ASSIGNED_GROUP_FK2;

drop index ASSIGNED_GROUP_FK;

drop index ASSIGNED_GROUP_PK;

drop table note.ASSIGNED_GROUP;

drop index HAS_FK4;

drop index DERIVED_FROM_FK;

drop index CRITERION_RUBRIC_FK;

drop index GOAL_CRITERION_FK;

drop index CRITERION_PK;

drop table note.CRITERION;

drop index DEFAULT_SCORE_GROUP_FK3;

drop index DEFAULT_SCORE_GROUP_FK2;

drop index DEFAULT_SCORE_GROUP_FK;

drop index DEFAULT_SCORE_GROUP_PK;

drop table note.DEFAULT_SCORE_GROUP;

drop index EDUCATIONNAL_GOAL_PK;

drop table note.EDUCATIONNAL_GOAL;

drop index EDUCATIONNAL_GOAL_HIERARCHY2_FK;

drop index EDUCATIONNAL_GOAL_HIERARCHY_FK;

drop index EDUCATIONNAL_GOAL_HIERARCHY_PK;

drop table note.EDUCATIONNAL_GOAL_HIERARCHY;

drop index FOR_EDUCATIONNAL_GOAL_FK;

drop index FOR_TIMESPAN_FK;

drop index EDUCATIONNAL_GOAL_INSTANCE_PK;

drop table note.EDUCATIONNAL_GOAL_INSTANCE;

drop index LINKED_TO_FK3;

drop index GIVE_FK;

drop index ENDORSED_BY_FK;

drop index ENDORSEMENT_PK;

drop table note.ENDORSEMENT;

drop index ENDORSEMENT_LEVEL_PK;

drop table note.ENDORSEMENT_LEVEL;

drop index EVALUATED_GROUP_FK2;

drop index EVALUATED_GROUP_FK;

drop index EVALUATED_GROUP_PK;

drop table note.EVALUATED_GROUP;

drop index LINKED_TO_FK;

drop index OF_TYPE_FK;

drop index EVALUATION_PK;

drop table note.EVALUATION;

drop index FOR_COURSE_FK;

drop index IN_CHARGE_OF_FK;

drop index LINKED_TO_FK2;

drop index EVALUATION_INSTANCE_PK;

drop table note.EVALUATION_INSTANCE;

drop index EVALUATION_RUBRIC_FK2;

drop index EVALUATION_RUBRIC_FK;

drop index EVALUATION_RUBRIC_PK;

drop table note.EVALUATION_RUBRIC;

drop index EVALUATION_TYPE_PK;

drop table note.EVALUATION_TYPE;

drop index RELATIVE_TO_FK;

drop index HAS_FK;

drop index ASSESSMENT_CRITERIA_FK;

drop index GENERIC_CRITERION_PK;

drop table note.GENERIC_CRITERION;

drop index RELATED_TO_FK4;

drop index RELATED_TO_FK3;

drop index HAS_FK5;

drop index GENERIC_INDICATOR_PK;

drop table note.GENERIC_INDICATOR;

drop index RELATIVE_TO_FK3;

drop index GENERIC_LEVEL_PK;

drop table note.GENERIC_LEVEL;

drop index RELATIVE_TO_FK2;

drop index GENERIC_LEVEL_AGGREGATE_PK;

drop table note.GENERIC_LEVEL_AGGREGATE;

drop index GENERIC_LEVEL_RATIO_FK2;

drop index GENERIC_LEVEL_RATIO_FK;

drop index GENERIC_LEVEL_RATIO_PK;

drop table note.GENERIC_LEVEL_RATIO;

drop index ORDERED_BY_FK2;

drop index ORDERING_FK2;

drop index GEN_LEVEL_ORDER_IN_AGGREGATE_PK;

drop table note.GEN_LEVEL_ORDER_IN_AGGREGATE;

drop index GROUP_ENDORSEMENT_LEVEL_FK3;

drop index GROUP_ENDORSEMENT_LEVEL_FK2;

drop index GROUP_ENDORSEMENT_LEVEL_FK;

drop index GROUP_ENDORSEMENT_LEVEL_PK;

drop table note.GROUP_ENDORSEMENT_LEVEL;

drop index RELATED_TO_FK2;

drop index RELATED_TO_FK;

drop index HAS_FK2;

drop index INDICATOR_PK;

drop table note.INDICATOR;

drop index INDICATOR_TYPE_PK;

drop table note.INDICATOR_TYPE;

drop index LEVEL_PK;

drop table note.LEVEL;

drop index LEVEL_AGGREGATE_PK;

drop table note.LEVEL_AGGREGATE;

drop index ORDERED_BY_FK;

drop index ORDERING_FK;

drop index LEVEL_ORDER_IN_AGGREGATE_PK;

drop table note.LEVEL_ORDER_IN_AGGREGATE;

drop index LEVEL_RATIO_FK2;

drop index LEVEL_RATIO_FK;

drop index LEVEL_RATIO_PK;

drop table note.LEVEL_RATIO;

drop index POSSIBLE_SCORE_PK;

drop table note.POSSIBLE_SCORE;

drop index PROGRAM_EDUCATIONNAL_GOAL_FK2;

drop index PROGRAM_EDUCATIONNAL_GOAL_FK;

drop index PROGRAM_EDUCATIONNAL_GOAL_PK;

drop table note.PROGRAM_EDUCATIONNAL_GOAL;

drop index PROGRAM_QUALITY_FK2;

drop index PROGRAM_QUALITY_FK;

drop index PROGRAM_QUALITY_PK;

drop table note.PROGRAM_QUALITY;

drop index QUALITY_PK;

drop table note.QUALITY;

drop index RECIPIENT_FK;

drop index FOR_FK;

drop index RELATING_TO_FK;

drop index INSERTED_BY_FK;

drop index RESULT_PK;

drop table note.RESULT;

drop index RUBRIC_PK;

drop table note.RUBRIC;

drop index SCORE_GROUP_PK;

drop table note.SCORE_GROUP;

drop index GROUPING_FK;

drop index HAS_FK3;

drop index SCORE_GROUP_DEFINITION_PK;

drop table note.SCORE_GROUP_DEFINITION;

drop index FOR_COURSE_INSTANCE_FK;

drop index LINKED_TO_INSTANCE_FK;

drop index SCORE_GROUP_INSTANCE_PK;

drop table note.SCORE_GROUP_INSTANCE;

drop index SCORE_THRESHOLD_DEFINITION_FK3;

drop index SCORE_THRESHOLD_DEFINITION_FK2;

drop index SCORE_THRESHOLD_DEFINITION_FK;

drop index SCORE_THRESHOLD_DEFINITION_PK;

drop table note.SCORE_THRESHOLD_DEFINITION;

drop index FOR_COURSE_FK2;

drop index IN_FK;

drop index HAS_SCORE_FK;

drop index STUDENT_SCORE_PK;

drop table note.STUDENT_SCORE;

drop index TRANSFORM_FK2;

drop index TRANSFORM_FK;

drop index TRANSFORM_PK;

drop table note.TRANSFORM;
*/
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1sn', 'session 1 profil d''acceuil sn', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1te', 'session 1 profil d''acceuil te', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1ti', 'session 1 profil d''acceuil ti', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1to', 'session 1 profil d''acceuil to', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'ges2', 'session 2 génie électrique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); 
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gis2', 'session 2 génie informatique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'ges3', 'session 3 génie électrique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gis3', 'session 3 génie informatique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'ges4', 'session 4 génie électrique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gis4', 'session 4 génie informatique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'ges5', 'session 5 génie électrique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gis5', 'session 5 génie informatique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'ges6', 'session 6 génie électrique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gis6', 'session 6 génie informatique', '', 0, now(), DEFAULT, now(), 1, 2); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI');
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 's7', 'session 7', '', 0, now(), DEFAULT, now(), 1, 2);
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app1sn', 'APP 1 SN', 'Réalisation et mesure de circuits électriques', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app1tetito', 'APP 1 TE TI TO', 'Mathématiques de base pour l''ingénieur', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app2snte', 'APP 2 SN+TE', 'Programmation et algorithmes', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app2tito', 'APP 2 TI+TO', 'Lois fondamentales de l''électricité', 0, now(), DEFAULT, now(), 1, 5);INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app3sntito', 'APP 3 SN+TI+TO', 'Circuits et physique des semi-conducteurs', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn');INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app3te', 'APP 3 TE', 'Électromagnétisme et physique des semi-conducteurs', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app4', 'APP 4', 'Circuits, systèmes du 1er ordre et physique des semi-conducteurs', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app5snte', 'APP 5 SN+TE', 'Atelier de programmation', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app5tito', 'APP 5 TI+TO', 'Physique des ondes', 0, now(), DEFAULT, now(), 1, 5);INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1app6', 'APP 6', 'Circuits, systèmes du 2ème ordre et physique des semi-conducteurs', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1projet', 'Projet s1', 'Concours robot-jouet', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1finauxsn', 'Finaux s1 sn', '', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1sn');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1finauxte', 'Finaux s1 te', '', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1finauxti', 'Finaux s1 ti', '', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'geis1finauxto', 'Finaux s1 to', '', 0, now(), DEFAULT, now(), 1, 5); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen133', 'GEN 133', 'Lois fondamentales de l''électricité', 0, now(), DEFAULT, now(), 1, 3); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen134', 'GEN 134', 'Électricité et magnétisme', 0, now(), DEFAULT, now(), 1, 3); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1te'); 
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen160', 'GEN 160', 'Physique des ondes', 0, now(), DEFAULT, now(), 1, 3); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GE'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'GI'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1ti'); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'geis1to');
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen124-1', 'GEN 124-1', 'Compétence 1', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen124');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen124-2', 'GEN 124-2', 'Compétence 2', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen124');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen133-1', 'GEN 133-1', 'Compétence 1', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen133');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen133-2', 'GEN 133-2', 'Compétence 2', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen133');

INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen134-1', 'GEN 134-1', 'Compétence 1', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen134');
...
INSERT INTO note.educationnal_goal(eg_id, label, short_description, description, administrative_value, validity_start, validity_end, registration, user_id, eg_type_id) VALUES (DEFAULT, 'gen160-1', 'GEN 160-1', 'Compétence 1', 0, now(), DEFAULT, now(), 1, 4); INSERT INTO note.educationnal_goal_hierarchy (SELECT a.eg_id, b.eg_id, now(), 1 FROM note.educationnal_goal a JOIN ( select last_value as eg_id from note.educationnal_goal_eg_id_seq ) b ON 1=1 WHERE a.label = 'gen160');
